...
class Wrapper {
    ...
    formatUrl(nodeId, path) {
        return `https://api/${nodeId}/${this.options.enviroment}.ekoopensource.com/${path}`;
    }
    ...
    get(nodeId, path, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const requestOptions = Object.assign(Object.assign({}, this.options), { data: payload });
            const url = this.formatUrl(nodeId, path);
            return requests_1.default(`GET`, 'https://api.nytimes.com/svc/books/v3/lists', requestOptions);
        });
    }
}
